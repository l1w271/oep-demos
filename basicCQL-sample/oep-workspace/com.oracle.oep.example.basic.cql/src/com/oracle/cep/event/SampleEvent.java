...
public class SampleEvent {
	...
	public String toString(){
		return "SampleEvent [eventID=" + eventID + ", eventType=" + eventType + ", eventKey=" + eventKey + ", eventValue=" + eventValue + ", state=" + state + "]";		 
	}
	public void setEventIntValue(int eventIntValue) {
		this.eventIntValue = eventIntValue;
	}
