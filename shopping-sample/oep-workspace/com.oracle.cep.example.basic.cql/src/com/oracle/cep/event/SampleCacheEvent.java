...
public class SampleCacheEvent implements Serializable {
	...
	public String toString(){
		return "SampleCacheEvent [eventID=" + eventID + ", eventType=" + eventType + ", eventKey=" + eventKey + ", eventValue=" + eventValue + ", state=" + state + "]";		 
	}
